  ...
  return (
    <div className="text-color ms-5 me-5 mr-5 mt-3">
      ...
      <b>
        ...
        <br />
        <br />
        Established with a vision to provide a comprehensive solution, our
        platform caters to the diverse needs of customers, couriers, and
        administrators alike. We are committed to delivering excellence,
        ensuring seamless operations, and creating a user-centric experience
